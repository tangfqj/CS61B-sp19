...
public class DebugExercise2 {
    ...
    public static int max(int a, int b) {
        // Bug here!  The max method doesn't work in the way we want.
        // So I rewrite the method and comment the original one.
...
//        return max;
    ...
    public static int add(int a, int b) {
        // Bug here!  The add method doesn't work in the way we want.
        // So I rewrite the method and comment the original one.
